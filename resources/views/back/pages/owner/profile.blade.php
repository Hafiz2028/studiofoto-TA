    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
        <div class="pd-20 card-box height-100-p">
            <div class="profile-photo">
                <a href="javascript:;" onclick="event.preventDefault();document.getElementById('ownerProfilePictureFile').click();" class="edit-avatar"><i class="fa fa-pencil"></i></a>
                <img src="{{ $owner->picture }}" alt="" class="avatar-photo" id="ownerProfilePicture">
                <input type="file" name="ownerProfilePictureFile" id="ownerProfilePictureFile" class="d-none" style="opacity:0"
                >
            </div>
            <h5 class="text-center h5 mb-0" id="ownerProfileName">{{ $owner->name}}</h5>
            <p class="text-center text-muted font-14" id="ownerProfileEmail">
                {{ $owner->email}}
            </p>
