...
@push('scripts')
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function setupFileInput(input) {
                input.addEventListener('change', function() {
                    updateLabel(this);
                    uploadedFiles[input.id] = this.files[0].name;
                });
            }

            function createFileInputGroup() {
                const inputGroup = document.createElement('div');
                inputGroup.className = 'col-lg-4 col-md-6 col-sm-6 mb-3';
                ...
                customFileLabel.textContent = 'Input Hasil Foto dari Layanan...';
                ...
                additionalImagesContainer.appendChild(inputGroup);
    ...
    {{-- preview foto
    <script>
        function addImagePreview(fileInput, previewContainer) {
        ...
        function addPreviewForInput(inputId, previewContainerId) {
            const input = document.getElementById(inputId);
            const previewContainer = document.getElementById(previewContainerId);

            input.addEventListener('change', function() {
                previewContainer.innerHTML = '';
                addImagePreview(input, previewContainer);
            });
        }

        addPreviewForInput('catalogInput', 'catalogPreview');
        addPreviewForInput('imagesInput', 'imagesPreview');
    </script> --}}
