            ...
            <div class="row align-items-center">
                <div class="col-5">
                    <div class="input-group mb-0">
                        ...
                        <input class="btn btn-primary btn-lg btn-block" style="background-color:#e27201; border-color:#e27201" type="submit" value="Submit">
                ...
                <div class="col-5">
                    <div class="input-group mb-0">
                        <a class="btn btn-outline-primary btn-lg btn-block custom-btn-outline" href="{{ route('admin.login') }}">Login</a>
                    </div>
                </div>
            </div>
        </form>
