                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        ...
                        <div class="pull-right">
                            <a href="{{ route('admin.user.customer.create') }}" class="btn btn-primary btn-sm"
                                type="button">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <a class="dropdown-item text-primary"
                                                        href="{{ route('admin.user.customer.edit', $item->id) }}"><i
                                                    ...
                                                    <form id="delete-form-{{ $item->id }}"
                                                        action="{{ route('admin.user.customer.destroy', $item->id) }}"
